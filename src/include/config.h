...
// Pin per pulsante di configurazione WiFi (pulsante del T-Display)
#define CONFIG_BUTTON_PIN 35  // Pulsante destro del T-Display

// Pulsante fisico per avvio rapido "Funerale" (default: GPIO0 - pulsante sinistro T-Display)
#ifndef FUNERAL_BUTTON_PIN
#define FUNERAL_BUTTON_PIN 0
#endif
...
// Programmazione
#define MAX_WEEKLY_SCHEDULES 20         // Max programmazioni settimanali
