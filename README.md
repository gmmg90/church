...
Sistema per il controllo delle campane con ESP32, interfaccia Web, RTC DS3231 e due relè. Supporta preset “FUNERALE” e “CHIAMATA MESSA”, backup/ripristino della configurazione, programmazione semplificata e pulsante fisico per avvio rapido.
...
- Pulsante fisico “FUNERALE” (GPIO0, T‑Display sinistro)
...
- LED stato su GPIO2
- Pulsanti:
	- CONFIG_BUTTON_PIN=35 (T‑Display destro)
	- FUNERAL_BUTTON_PIN=0 (T‑Display sinistro)
...
- `FUNERAL_BUTTON_PIN` (default 0): se premuto (debounce + cooldown), avvia la melodia slot 0 se non è in corso altra riproduzione.
